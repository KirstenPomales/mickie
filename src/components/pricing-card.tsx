...
export function PricingCard({
  ...
  return (
    <Card className={cn("relative border-0 shadow-lg", className)}>
      ...
      {isMostPopular === true && (
        <span className="absolute inset-x-0 -top-5 mx-auto w-32 rounded-full bg-primary bg-gradient-to-br from-secondary px-3 py-2 text-center text-sm font-semibold text-primary-foreground shadow-md">
          Most popular
        </span>
      )}
    </Card>
